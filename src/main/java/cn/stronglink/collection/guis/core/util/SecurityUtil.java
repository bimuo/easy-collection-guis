...
import cn.stronglink.collection.guis.core.support.security.BASE64Encoder;
import cn.stronglink.collection.guis.core.support.security.coder.DESCoder;
import cn.stronglink.collection.guis.core.support.security.coder.HmacCoder;
import cn.stronglink.collection.guis.core.support.security.coder.MDCoder;
import cn.stronglink.collection.guis.core.support.security.coder.RSACoder;
import cn.stronglink.collection.guis.core.support.security.coder.SHACoder;
...
public class SecurityUtil {
	 ...
	 * 
	 */
	private static final byte[] ENCRYPT_KEY = { 9, -1, 0, 5, 39, 8, 6, 19 };
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(encryptDes("UERM"));
		System.out.println(decryptDes("v7Bd9g8q9Ez4x/ASk+iWIq=="));
